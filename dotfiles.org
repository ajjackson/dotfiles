...
** Config
   :PROPERTIES:
   :header-args: :tangle "moc/.moc/config" :mkdirp yes :tangle-mode (identity #o644)
   :END:
...
Custom colour theme, nothing especially clever but looks nice on most of my machines.
    ...
    #+BEGIN_SRC conf :tangle moc/.moc/themes/my_theme :padlines none :mkdirp yes
...
#+BEGIN_SRC conf :tangle moc/.moc/my_keymap
  # MOC control keys:
  quit_client           = q
  quit                  = Q
