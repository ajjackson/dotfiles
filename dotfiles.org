        ...
        (let ((hostname (system-name)))
          (cond ((member hostname '("Angel" "Angel.lan" "Angel.local")) "Angel")
                ((member hostname '("ajj-mbp-1" "ajj-mbp-1.local"
                 ...
                 "ajj-mbp-1")
                ((string= (substring (system-name) -16) "nubes.stfc.ac.uk") "SCD-cloud")
...
#+begin_src conf :tangle (if (equal system "NonExistent") "i3/dot-config/i3/config" "no")
...
#+begin_src conf :tangle (if-workstation "i3/dot-config/picom.conf" "no")
  corner-radius = 10;
...
#+begin_src conf :mkdirp yes :tangle (if (equal system "scpc041") "i3/dot-config/i3/config" "no")
  # Sort out monitor positions
...
#+begin_src fish :tangle (if (equal system "scpc041") "fish/dot-config/fish/config.fish" "no")
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
...
On SCD-cloud images we also need to add ~/.local/bin: do this before
mamba stuff so environments take priority.
#+begin_src fish :tangle (if (equal system "SCD-cloud") "fish/dot-config/fish/config.fish" "no")
set -xp PATH $HOME/.local/bin

# >>> mamba initialize >>>
# !! Contents within this block are managed by 'mamba init' !!
set -gx MAMBA_EXE "/home/prg49555/bin/micromamba"
set -gx MAMBA_ROOT_PREFIX "/home/prg49555/micromamba"
