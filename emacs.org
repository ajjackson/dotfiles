...
#+begin_src elisp :noweb-ref org-agenda-setup
  ...
  (set-if-exists 'org-directory "~/org" org-directory)
...
The key commands are org-roam-node-insert, org-roam-node-find,
org-roam-capture. I'll probably want to assign hotkeys to those.
